...
// Program Designing calculators array
const calculators = [
  { name: "Training Split Planner", route: "/program-designing/calculator/training-split" },
  { name: "Periodization Schedule Generator", route: "/program-designing/calculator/periodization-schedule" },
  { name: "Goal-Based Program Builder", route: "/program-designing/calculator/goal-based-program" },
  { name: "Recovery and Rest Day Planner", route: "/program-designing/calculator/recovery-planner" },
  { name: "Load Progression Calculator", route: "/program-designing/calculator/load-progression" },
];

export default function ProgramDesigningPage(): JSX.Element {
  ...
  // Fetch data via TopicService using the "program-designing" topic
  const fetchFreshData = useCallback(async () => {
    try {
      const subTopics = await topicService.GetSubTopics("program-designing");
      const latest = await topicService.GetLatestPosts("program-designing", 5);
  ...
  const handleFileClick = useCallback((fileId: string): void => {
    router.prefetch(`/program-designing/file/${fileId}`);
    router.push(`/program-designing/file/${fileId}`);
  }, [router]);
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <Image
          src="/images/program-designing.webp"
          alt="Program Designing Background"
          fill
          priority
      ...
      <header ref={breadcrumbRef} className="mx-4 sm:mx-6 lg:mx-16 mt-6">
        <BreadcrumbNavigation
          crumbs={[
            { label: "Home", href: "/" },
            { label: "Program Designing", href: "/program-designing" },
          ]}
        />
      </header>
      ...
      <main className="relative z-10 mx-4 sm:mx-6 lg:mx-16 my-6 p-4 sm:p-6 lg:p-8 bg-white/70 dark:bg-gray-900/70 backdrop-blur-sm rounded-[20px] sm:rounded-[30px] shadow-lg">
        ...
        <section ref={heroContentRef} className="flex flex-col items-center text-center py-4 sm:py-6 mb-6">
          ...
          <p className="mt-2 text-sm sm:text-base md:text-lg text-gray-700 dark:text-gray-300 max-w-xl">
            Build effective training programs tailored to specific goals and needs.
          </p>
        </section>
          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <p className="text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">
                Browse various program designing subtopics to discover in-depth content.
              </p>
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm md:text-base text-gray-700 dark:text-gray-300">
                Utilize our specialized calculators for program planning.
              </p>
